...
public class SessionController extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        if (request.getSession().getAttribute("account") != null) {
            ArrayList<Session> sessions = db.getSessionsByUserID(((Account) request.getSession().getAttribute("account")).getId(), new Date(122, 6, 16));
            ...
            request.getRequestDispatcher("view/instructor/weekly.jsp");
        } else {
